/*
 * halm/platform/numicro/m03x/pdma_defs.h
 * Copyright (C) 2023 xent
 * Project is distributed under the terms of the MIT License
 */

#ifndef HALM_PLATFORM_NUMICRO_M03X_PDMA_DEFS_H_
#define HALM_PLATFORM_NUMICRO_M03X_PDMA_DEFS_H_
/*----------------------------------------------------------------------------*/
...
#define DSCT_NEXT_NEXT(value)           BIT_FIELD((value), 0)
#define DSCT_NEXT_NEXT_MASK             BIT_FIELD(MASK(16), 0)
#define DSCT_NEXT_NEXT_VALUE(reg) \
    FIELD_VALUE((reg), DSCT_NEXT_NEXT_MASK, 0)

#define DSCT_NEXT_EXENEXT(value)        BIT_FIELD((value), 16)
#define DSCT_NEXT_EXENEXT_MASK          BIT_FIELD(MASK(16), 16)
#define DSCT_NEXT_EXENEXT_VALUE(reg) \
    FIELD_VALUE((reg), DSCT_NEXT_EXENEXT_MASK, 16)
/*------------------Channel Control register----------------------------------*/
#define CHCTL_CH(channel)               BIT(channel)
#define CHCTL_CH_MASK                   BIT_FIELD(MASK(9), 0)
/*------------------Transfer Pause Control register---------------------------*/
#define PAUSE_CH(channel)               BIT(channel)
#define PAUSE_CH_MASK                   BIT_FIELD(MASK(9), 0)
...
#define INTEN_CH_MASK                   BIT_FIELD(MASK(9), 0)
...
#define SCATBA_SCATBA(value)            BIT_FIELD((value), 16)
#define SCATBA_SCATBA_MASK              BIT_FIELD(MASK(16), 16)
#define SCATBA_SCATBA_VALUE(reg) \
    FIELD_VALUE((reg), SCATBA_SCATBA_MASK, 16)
...
#define CHRST_CH_MASK                   BIT_FIELD(MASK(9), 0)
...
/*----------------------------------------------------------------------------*/
#endif /* HALM_PLATFORM_NUMICRO_M03X_PDMA_DEFS_H_ */
