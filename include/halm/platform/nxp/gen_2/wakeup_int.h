/*
 * halm/platform/nxp/gen_2/wakeup_int.h
 * Copyright (C) 2015, 2020 xent
 * Project is distributed under the terms of the GNU General Public License v3.0
 */

#ifndef HALM_PLATFORM_NXP_GEN_2_WAKEUP_INT_H_
#define HALM_PLATFORM_NXP_GEN_2_WAKEUP_INT_H_
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
#endif /* HALM_PLATFORM_NXP_GEN_2_WAKEUP_INT_H_ */
