/*
 * halm/platform/lpc/lpc13uxx/clocking_defs.h
 * Copyright (C) 2020 xent
 * Project is distributed under the terms of the GNU General Public License v3.0
 */

#ifndef HALM_PLATFORM_LPC_LPC13UXX_CLOCKING_DEFS_H_
#define HALM_PLATFORM_LPC_LPC13UXX_CLOCKING_DEFS_H_
/*----------------------------------------------------------------------------*/
#include <xcore/bits.h>
/*------------------Clock Output Source Select register-----------------------*/
#define CLKOUTSEL_IRC                   BIT_FIELD(0, 0)
#define CLKOUTSEL_SYSOSC                BIT_FIELD(1, 0)
#define CLKOUTSEL_WDT                   BIT_FIELD(2, 0)
#define CLKOUTSEL_MAIN_CLOCK            BIT_FIELD(3, 0)
...
/*----------------------------------------------------------------------------*/
#endif /* HALM_PLATFORM_LPC_LPC13UXX_CLOCKING_DEFS_H_ */
