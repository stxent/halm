/*
 * platform/nxp/lpc17xx/usb_defs.h
 * Copyright (C) 2015 xent
 * Project is distributed under the terms of the GNU General Public License v3.0
 */

#ifndef PLATFORM_NXP_LPC17XX_USB_DEFS_H_
#define PLATFORM_NXP_LPC17XX_USB_DEFS_H_
/*----------------------------------------------------------------------------*/
#include <bits.h>
...
#define USBDevIntSt_EP_FAST             BIT(1)
#define USBDevIntSt_EP_SLOW             BIT(2)
#define USBDevIntSt_DEV_STAT            BIT(3)
#define USBDevIntSt_CCEMPTY             BIT(4)
#define USBDevIntSt_CDFULL              BIT(5)
#define USBDevIntSt_RxENDPKT            BIT(6)
#define USBDevIntSt_TxENDPKT            BIT(7)
#define USBDevIntSt_EP_RLZED            BIT(8)
#define USBDevIntSt_ERR_INT             BIT(9)
