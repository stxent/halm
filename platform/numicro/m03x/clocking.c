...
static const enum ClockSource sourceMap[GROUP_COUNT][SOURCE_COUNT] = {
    ...
    {
        CLOCK_EXTERNAL,   // BRANCH_SOURCE_HXT,
        CLOCK_PLL,        // BRANCH_SOURCE_ADC_SPI_PLL,
        CLOCK_APB,        // BRANCH_SOURCE_ADC_SPI_PCLK,
        CLOCK_INTERNAL,   // BRANCH_SOURCE_HIRC,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED   // SOURCE_RESERVED
    },
    ...
    /* BRANCH_GROUP_PWM */
    {
        CLOCK_PLL,        // BRANCH_SOURCE_PWM_PLL,
        CLOCK_APB,        // BRANCH_SOURCE_PWM_PCLK,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
    ...
    {
        CLOCK_EXTERNAL,     // BRANCH_SOURCE_HXT,
        CLOCK_RTC,          // BRANCH_SOURCE_LXT,
        CLOCK_APB,          // BRANCH_SOURCE_TMR_PCLK,
        CLOCK_TMR,          // BRANCH_SOURCE_TMR_TM,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_LIRC,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_INTERNAL      // BRANCH_SOURCE_TMR_HIRC
    },

    /* BRANCH_GROUP_UART */
    {
        CLOCK_EXTERNAL,     // BRANCH_SOURCE_HXT,
        CLOCK_PLL,          // BRANCH_SOURCE_UART_PLL,
        CLOCK_RTC,          // BRANCH_SOURCE_UART_LXT,
        CLOCK_INTERNAL,     // BRANCH_SOURCE_HIRC,
        CLOCK_APB,          // BRANCH_SOURCE_PCLK,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_LIRC,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED     // SOURCE_RESERVED
    },
    ...
    /* BRANCH_GROUP_CLKO */
    {
        CLOCK_EXTERNAL,     // BRANCH_SOURCE_HXT,
        CLOCK_RTC,          // BRANCH_SOURCE_LXT,
        CLOCK_MAIN,         // BRANCH_SOURCE_HCLK,
        CLOCK_INTERNAL,     // BRANCH_SOURCE_HIRC,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_CLKO_LIRC,
        CLOCK_INTERNAL,     // BRANCH_SOURCE_CLKO_HIRC,
        CLOCK_PLL,          // BRANCH_SOURCE_CLKO_PLL,
        CLOCK_UNDEFINED     // SOURCE_RESERVED
    },
    ...
    /* BRANCH_GROUP_HCLK */
    {
        CLOCK_EXTERNAL,     // BRANCH_SOURCE_HXT,
        CLOCK_RTC,          // BRANCH_SOURCE_LXT,
        CLOCK_PLL,          // BRANCH_SOURCE_HCLK_PLL,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_HCLK_LIRC,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_INTERNAL      // BRANCH_SOURCE_HCLK_HIRC
    },
    ...
    /* BRANCH_GROUP_STCLK */
    {
        CLOCK_EXTERNAL,   // BRANCH_SOURCE_HXT,
        CLOCK_RTC,        // BRANCH_SOURCE_LXT,
        CLOCK_EXTERNAL,   // BRANCH_SOURCE_STCLK_HXT_DIV2,  // TODO
        CLOCK_MAIN,       // BRANCH_SOURCE_STCLK_HCLK_DIV2, // TODO
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_INTERNAL    // BRANCH_SOURCE_STCLK_HIRC_DIV2  // TODO
    },

    /* BRANCH_GROUP_USB */
    {
        CLOCK_INTERNAL,   // BRANCH_SOURCE_USB_HIRC,
        CLOCK_PLL,        // BRANCH_SOURCE_USB_PLL,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
        CLOCK_UNDEFINED,  // SOURCE_RESERVED,
    ...
    /* BRANCH_GROUP_WDT */
    {
        ...
        CLOCK_RTC,          // BRANCH_SOURCE_LXT,
        CLOCK_MAIN,         // BRANCH_SOURCE_HCLK,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_WDT_LIRC,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED     // SOURCE_RESERVED
    ...
    /* BRANCH_GROUP_WWDT */
    {
        ...
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_MAIN,         // BRANCH_SOURCE_HCLK,
        CLOCK_INTERNAL_LS,  // BRANCH_SOURCE_WWDT_LIRC,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED,    // SOURCE_RESERVED,
        CLOCK_UNDEFINED     // SOURCE_RESERVED
